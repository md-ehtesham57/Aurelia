...
const Footer = () => {
  return (
    <footer className="bg-surface border-t border-bg mt-fluid-20">
      <div className="max-w-7xl mx-auto px-fluid-4 py-fluid-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-fluid-8">
          <div>
            <h4 className="font-serif text-lg mb-fluid-4">AURELIA</h4>
            <p className="text-sm text-text-muted leading-relaxed">
              Wear the Warmth of Gold. Crafted with care, designed for life.
            </p>
          </div>
          <div>
            <h5 className="text-sm font-medium mb-fluid-3">Shop</h5>
          ...
          <div>
            <h5 className="text-sm font-medium mb-fluid-3">Support</h5>
            <ul className="space-y-fluid-2">
          ...
          <div>
            <h5 className="text-sm font-medium mb-fluid-3">Company</h5>
            <ul className="space-y-fluid-2">
        ...
        <div className="border-t border-bg mt-fluid-8 pt-fluid-6 text-center text-xs text-text-muted">
